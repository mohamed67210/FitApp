...
//         // La condition de la media query est satisfaite
//         window.addEventListener('scroll', function () {
//             var detailssection = document.getElementById('programme_infos_avis_section');
//             var height = detailssection.clientHeight;
//             var div = document.getElementById('programme_card_container_section');
//             var seuil = height; // seuil de défilement à partir duquel la div s'arrête

//             if (window.pageYOffset > seuil) {
//                 console.log(height)
//                 div.style.position = 'absolute';
//                 div.style.top = (seuil - 250) + 'px';
//             } 
//             // else {
...
//             // }
//         });
//         console.log('La condition de la media query est satisfaite.');
//     } else {
//         // La condition de la media query n'est pas satisfaite
//         // Votre code spécifique pour cette condition ici
//         console.log('La condition de la media query n\'est pas satisfaite.');
//     }
// }

// // Appel initial de la fonction pour vérifier la condition de la media query
// handleMediaQuery(mediaQuery);

// // Ajouter un écouteur d'événement pour détecter les changements dans la condition de la media query
